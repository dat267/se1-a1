...
public class Doc {
	 ...
	 * Documents are provided as text files (.txt) in the docs directory under the project’s root directory.
	 * Each text file contains two lines. The first line is the title and the second line is the body.
	 *
	...
	/**
	 * Checks the equality of two Doc objects. Two Doc objects are equal if their titles and bodies contain the same words in the same order.
	 * To determine if two words are equal, we use the equals() method from the Word class.
	 *
