...
/**
 * The Result class represents a document found in the search engine.
 * Each Result object stores information about a related document, a list of matches found in that document,
 * and also three derived properties: match count, total frequency, and average first index.
 * This class implements the Comparable interface to allow results to be sorted based on match count, total frequency, and average first index.
 */
