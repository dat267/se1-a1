...
public class Query {
    ...
    /**
     * Constructs a Query object with the given search phrase. The search phrase is split into
     * words, and only those that are not stop words are added to the keywords list.
     *
    ...
    /**
     * Returns a list of the query's keywords in the same order as they appear in the raw search
     * phrase.
     *
    ...
    /**
     * Returns a list of matches against the given document. The matches are sorted by the position
