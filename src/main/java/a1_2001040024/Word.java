...
public class Word {
    ...
    /**
     * Computes the hash code for this Word instance. The hash code is computed based on the text
     * part of the Word, case-insensitively. This means that two Word instances with the same text
     * part but different cases will have the same hash code.
     *
